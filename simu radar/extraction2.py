...
phi_rad_new = []
v_rad_new = []
with open('data_final.csv','w',newline='') as myWriter:
            ...
            if len(lister) != 0:
                ...
                if(len(d_rad) != 0 and len(data_val) != 0):
                    for i in range(len(d_rad)):
                        ...
                        writer.writerow((index,data_corr[0],data_corr[1],data_corr[2],data_val[i,3],data_corr[3],data_corr[4],data_corr[5],data_corr[6]))
        count+=1
